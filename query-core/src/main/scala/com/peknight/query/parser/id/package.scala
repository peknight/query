...
package object id:
  ...
  def parse[A](options: List[String])(transformShortOption: Char => String = _.toString)(using Decoder[Id, Cursor[Query], A]): Either[Error, A] =
    com.peknight.query.parser.parse[Id, A](options)(transformShortOption)
