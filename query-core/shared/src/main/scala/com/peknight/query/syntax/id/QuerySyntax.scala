...
trait QuerySyntax:
  extension [A] (a: A)
    ...
    def pairs(using Encoder[Id, Query, A], QueryConfig): Chain[(String, Option[String])] =
      Encoder[Id, Query, A].encode(a).pairs

    def toMap(using Encoder[Id, Query, A], QueryConfig): Map[String, Chain[String]] =
      Encoder[Id, Query, A].encode(a).toMap

    def toQueryString(using Encoder[Id, Query, A], QueryConfig): String =
  ...
  extension (input: String)
    ...
    def withQueryParams[A](a: A)(using Encoder[Id, Query, A], QueryConfig): Either[ParsingFailure, String] =
  ...
  extension (map: Map[String, Chain[String]])
    ...
    def withQueryParams[A](a: A)(using Encoder[Id, Query, A], QueryConfig): Either[ParsingFailure, Map[String, Chain[String]]] =
  ...
  extension (map: Map[String, collection.Seq[String]])
    ...
    def withSeqQueryParams[A](a: A)(using Encoder[Id, Query, A], QueryConfig): Either[ParsingFailure, Map[String, Seq[String]]] =
