...
trait QuerySyntax:
  extension [A] (a: A)
    def toQuery[F[_]](using Functor[F], Encoder[F, com.peknight.query.Query, A], QueryConfig): F[Query] = 
  ...
  extension (query: Query)
    ...
    def withQuery[F[_], A](a: A)(using Functor[F], Encoder[F, com.peknight.query.Query, A], QueryConfig): F[Query] =
