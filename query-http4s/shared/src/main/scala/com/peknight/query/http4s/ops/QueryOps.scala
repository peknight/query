...
object QueryOps:
  def toQuery[F[_], A](a: A)(using Functor[F], Encoder[F, com.peknight.query.Query, A], QueryConfig): F[Query] =
  ...
  def withQueryParams[F[_], A](query: Query, a: A)(using Functor[F], Encoder[F, com.peknight.query.Query, A], QueryConfig)
  : F[Query] =
