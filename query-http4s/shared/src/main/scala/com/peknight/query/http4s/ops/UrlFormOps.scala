...
object UrlFormOps:
  def toUrlForm[F[_], A](a: A)(using Functor[F], Encoder[F, Query, A], QueryConfig): F[UrlForm] =
  ...
  def withQueryParams[F[_], A](urlForm: UrlForm, a: A)(using Functor[F], Encoder[F, Query, A], QueryConfig): F[UrlForm] =
